...
| Metric | Direction | KCF | KCF_TLD |
| --- | --- | :---: | :---: |
| Mean Center Error (px) | Lower is better | 83.531 | 91.124 |
| Median Center Error (px) | Lower is better | 84.750 | 91.579 |
...
| Metric | Direction | KCF | KCF_TLD |
| --- | --- | :---: | :---: |
| Tracking Availability | Higher is better | 3.40% | 4.85% |
| Failure Frame Ratio | Lower is better | 96.60% | 95.15% |
| Longest Failure Streak Ratio | Lower is better | 96.60% | 53.72% |

## Computational Efficiency
| Metric | Direction | KCF | KCF_TLD |
| --- | --- | :---: | :---: |
| Average FPS | Higher is better | 321.81 | 113.66 |
