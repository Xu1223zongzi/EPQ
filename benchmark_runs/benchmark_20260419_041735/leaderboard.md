...
| Metric | Direction | KCF | KCF_TLD |
| --- | --- | :---: | :---: |
| Mean Center Error (px) | Lower is better | 83.531 | 113.867 |
| Median Center Error (px) | Lower is better | 84.750 | 112.760 |
...
| Metric | Direction | KCF | KCF_TLD |
| --- | --- | :---: | :---: |
| Tracking Availability | Higher is better | 3.40% | 5.83% |
| Failure Frame Ratio | Lower is better | 96.60% | 94.17% |
| Longest Failure Streak Ratio | Lower is better | 96.60% | 69.90% |

## Computational Efficiency
| Metric | Direction | KCF | KCF_TLD |
| --- | --- | :---: | :---: |
| Average FPS | Higher is better | 324.74 | 172.91 |
